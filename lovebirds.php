...
$sql='SELECT * FROM petinfo WHERE pet_Category="lovebird"';
...
<section class="main-body">
    <div class="page-through">
        <a href="homepage.php" class="breed-homepage">HOME &#62;</a>
        <a href="dog.php" class="breed-page">LOVEBIRDS</a>
    </div>
    <div class="head-box">
        <p class="category-name">LOVEBIRDS</p>
    </div>
    <div class="category-box">
    <?php
        if(count($result)>0){
        for($i=0;$i<count($result);$i++){
            echo '<div class="branch-box-anchor" style="margin-top: 130px; background-color: #ffe4ef;">';
            ...
            echo '<a href="add_to_cart.php?name='.$result[0][3].'"><button class="breed-buy">Add to cart</button></a>';
            echo '</div>';
            echo '</div>';
            echo '</div>';
        }
